...
class SpanLimits {
  ...
  SpanLimits({
    ...
    int? maxNumAttributeLength,
        ...
        _maxNumAttributesPerEvent = maxNumAttributesPerEvent ?? _DEFAULT_MAXNUM_ATTRIBUTE_PER_EVENT,
        _maxNumAttributesPerLink = maxNumAttributesPerLink ?? _DEFAULT_MAXNUM_ATTRIBUTES_PER_LINK,
        _maxNumAttributeLength = maxNumAttributeLength ?? _DEFAULT_MAXNUM_ATTRIBUTES_LENGTH;
